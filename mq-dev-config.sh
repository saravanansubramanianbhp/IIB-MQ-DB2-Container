...
if ! getent group mqclient; then
  ...
  groupadd --gid 2004 mqclient
fi
configure_os_user 2004 2004 MQ_APP_NAME MQ_APP_PASSWORD /home/app
...
configure_os_user 3001 2000 MQ_ADMIN_NAME MQ_ADMIN_PASSWORD /home/admin
